...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[9999] flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3.5 font-body text-[15px] font-semibold text-white shadow-[0_4px_12px_rgba(0,0,0,0.2)] transition-transform hover:scale-105 active:scale-95"
    >
      <svg
