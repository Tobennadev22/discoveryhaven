...
export const COURSES = [
  {
    ...
    description: 'A programme for young storytellers. Children write, edit, and publish creative fiction, non-fiction, and flash fiction pieces.',
    ages: '8–14',
    duration: '6 Weeks',
  ...
  },
  {
    ...
    description: 'A programme that transforms shy children into confident communicators. Voice modulation, debate, and public speaking.',
    ages: '9–15',
    duration: '6 Weeks',
    format: 'Virtual · Saturdays',
    color: '#de2d10',
    ...
    bonus: 'Final speech delivered before a live audience of parents and guests.',
    price: 45000,
  },
  {
    id: 'curiosity-box',
    ...
    description: 'A programme built for young investigators. Children explore logic, deduction, and collaborative problem-solving.',
    ages: '7–13',
    duration: '6 Weeks',
    format: 'Virtual · Saturdays',
    color: '#ffec00',
  ...
  },
  {
    ...
    description: 'A programme that builds self-awareness, empathy, and peaceful communication for young leaders.',
    ages: '6–12',
    duration: '4 Weeks',
    format: 'Virtual · Saturdays',
    color: '#7c3aed',
...
export const EVENTS = [
  {
    ...
    date: 'June 2026',
    duration: '4 Weeks',
    description: 'A virtual Saturday programme for ages 6–12. Building self-awareness, empathy, and peaceful communication.',
    dateBarColor: '#ffec00',
  ...
  },
  {
    ...
    date: 'August 2026',
    duration: '6 Weeks',
    description: 'Six weeks of story-building, character creation, and world-building. Final stories published in the DH Youth Anthology.',
    dateBarColor: '#ffec00',
    dateBarTextColor: '#1a1a1a',
    price: 45000,
    type: 'cohort',
  },
  {
    ...
    description: 'Our annual flagship summit. Virtual and Abuja. Performances, panels, awards, and the Little Voices book launch.',
    dateBarColor: '#de2d10',
...
export const TESTIMONIALS = [
  {
    quote: "My daughter completed Creative Quest and came home asking to write every weekend. She published her first story at age 9. Discovery Haven gave her a voice I never knew she had.",
    name: "Adaeze O.",
    role: "Parent, Lagos",
  },
  {
    quote: "After Loud & Fearless, my son gave a speech at his school assembly without a single note. The confidence he built in just six weeks was extraordinary.",
    name: "Emeka T.",
    role: "Parent, Abuja",
  },
  {
    quote: "The Curiosity Box changed how my daughter approaches problems. She now asks 'why' and 'how' before reacting. That's the kind of thinking that will carry her through life.",
    name: "Fatima A.",
    role: "Parent, Kano",
  },
]
...
export const VALUES = [
  {
    title: 'Autonomy',
    description: 'We respect the independent voice, logic, and natural learning cadence of every child.',
    icon: '🌱',
  },
  {
    title: 'Intellectual Integrity',
    description: 'We train investigators to seek empirical evidence and verify truth over trends.',
    icon: '🔬',
  },
  {
    title: 'Emotional Sovereignty',
    description: 'We teach self-regulation, ensuring children choose their responses rather than reacting to pressure.',
    icon: '💎',
  },
]
