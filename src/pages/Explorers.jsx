    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h2 className="font-cherry text-4xl text-dark mb-12">What Will YOU Do Here?</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {COURSES.map(c => (
              <div key={c.id} className="rounded-3xl p-6 text-center" style={{ backgroundColor: c.color + '20' }}>
