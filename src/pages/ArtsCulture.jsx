    ...
    <>
      ...
      <section className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[1,2,3,4].map(i => (
              <motion.div key={i} variants={scaleIn} className="aspect-[3/4] bg-gradient-to-br from-aqua/20 to-aqua/5 rounded-2xl flex items-center justify-center">
          ...
          >
            {[1,2,3].map(i => (
              <motion.div key={i} variants={scaleIn} className="aspect-video bg-dark rounded-2xl flex items-center justify-center">
