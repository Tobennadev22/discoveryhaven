...
const TRIBE_BENEFITS = [
  {
    ...
    title: "The Discovery Letter",
    desc: "Weekly newsletter on child development and creative learning — delivered every Monday.",
  },
  {
    icon: <Bell size={22} />,
    title: "Early Access",
    desc: "Register for new courses and cohorts before they open to the public.",
  },
  {
    icon: <Users size={22} />,
    title: "Community Events",
    desc: "Invitations to open days, parent information sessions, and community meetups.",
  },
  {
    icon: <Globe size={22} />,
    title: "Community Space",
    desc: "Access to the Discovery Haven community space for networking and collaboration.",
  },
];
      ...
      <section className="bg-aqua py-28">
        ...
        >
          ...
          <p className="text-white/85 font-body text-xl leading-relaxed">
            Our community of parents, educators, and advocates who believe every
            child deserves to come alive. Welcome to the tribe.
          </p>
        </motion.div>
      </section>
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                variants={scaleIn}
                className="bg-cream rounded-2xl p-6 text-left"
              >
              ...
              <motion.div key={i} variants={scaleIn}>
                <Card className="bg-white/5 border-white/10">
                  <div className="p-7">
                    ...
                    <h3 className="font-cherry text-xl text-white mb-2">
                      {b.title}
                    </h3>
