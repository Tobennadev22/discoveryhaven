        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {['Our Nigeria Publishing', 'Camping Nigeria', 'Partner 3', 'Partner 4'].map((p, i) => (
              <motion.div key={i} variants={scaleIn} className="bg-white rounded-2xl p-8 text-center border border-gray-100 hover:shadow-md transition-shadow">
          ...
          >
            {TIERS.map((t, i) => (
              <motion.div key={i} variants={scaleIn} className="bg-white rounded-2xl p-8 border border-gray-100 hover:shadow-md transition-shadow text-center">
