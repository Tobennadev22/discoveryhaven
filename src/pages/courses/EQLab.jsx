...
const COURSE = {
  ...
  subheadline:
    " A 4-week emotional intelligence and leadership course for ages 7–16. Classes run in two tracks — Track 1 for ages 7 to 11 and Track 2 for ages 12 to 16 — so every child engages with concepts at their developmental stage. They will learn to understand their emotions, manage pressure, and lead with maturity and grace.",
  ...
  faqSpecific: {
    q: "Is this suitable for younger children in the 6–8 age range?",
  ...
  finalCTA:
    "June cohort spots are limited. Give your child the skills that last a lifetime.",
};
