...
const COURSE = {
  ...
  faqSpecific: [
    {
      q: "Does my child need to be good at science?",
      a: "Not at all. The Curiosity Box is designed for curious minds, not science experts. Children who love art often thrive here because they bring a creative perspective that makes their investigations richer and more original.",
    },
    {
  ...
  finalCTA:
    "February spots are limited. Give your child the tools to think and create like no one else.",
};
