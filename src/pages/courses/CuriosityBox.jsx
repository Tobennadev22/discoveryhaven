...
const COURSE = {
  ...
  subheadline: "A 4-week science and logic lab for ages 7–12. Your child will solve real mysteries, test hypotheses, and build the critical thinking skills that make everything else easier.",
  smallText: "Limited spots · February 2026 Cohort · Starts Soon",
  problemHeading: "Does your child say science is boring — or that they're just not good at it?",
  problemBody: "Most STEM education asks children to memorise facts and repeat them on a test. It rarely asks them to think. The Curiosity Box takes a completely different approach — treating every session like a mystery to solve, where your child is the lead investigator. When learning feels like play, children stop saying they can't and start asking why.",
  ...
  testimonial: {
    quote: "My daughter used to give up the moment something got hard. After The Curiosity Box, she started saying 'let me investigate this' when she hit a problem. That shift in mindset is everything.",
    author: "Parent, Discovery Haven",
  },
  faqSpecific: { q: "Does my child need to be good at science or maths?", a: "No prior science knowledge needed. The Curiosity Box is about thinking skills, not content recall. Children of all academic levels thrive in it." },
  faqCommon: FAQ_COMMON,
  finalCTA: "February cohort spots are limited. Secure your child's place today.",
};
