...
const COURSE = {
  ...
  subheadline: "A 6-week writing studio for ages 7–12. Your child will write real stories, learn to think like a storyteller, and see their work published in our Youth Literary Anthology.",
  ...
  problemBody: "Most children are taught grammar rules and told to \"write an essay.\" Few are ever taught how to actually think like a writer — how to build a world, create a character worth rooting for, and structure a story that keeps people reading. That's the gap Creative Quest closes.",
  ...
  testimonial: {
    quote: "My daughter has always loved stories but never thought she could write her own. After Discovery Haven, she has written three more stories on her own at home. She calls herself an author now.",
    author: "Parent, Discovery Haven",
  },
  faqSpecific: { q: "Does my child need to already be a good writer?", a: "Not at all. Creative Quest is built for beginners and confident writers alike. Every child grows at their own pace." },
